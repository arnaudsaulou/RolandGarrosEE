...
public class AddMatchServlet extends HttpServlet {
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        {
            this.getServletContext().getRequestDispatcher("/WEB-INF/tournoi/addDoubleMatch.jsp").forward(req, resp);

        } else {
            this.getServletContext().getRequestDispatcher("/WEB-INF/tournoi/addSingleMatch.jsp").forward(req, resp);
        }
    }
}
